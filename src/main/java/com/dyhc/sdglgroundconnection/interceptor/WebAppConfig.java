    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new InterceptorConfig()).addPathPatterns("/**")
                .excludePathPatterns("/admins/login.html","/static/**","/Staff/login",
                        ...
                        "/WeChat/dictionaries","/WeChat/saveReportaccommodation",
                        "/RoomType/roomType_All","/Reportaccommodation/jiudianquanbu",
                        ...
                        "/WeChat/listBillType","/api/image/**","/WeChat/guideUpdate","/WeChat/assignmentGuide");
    }
