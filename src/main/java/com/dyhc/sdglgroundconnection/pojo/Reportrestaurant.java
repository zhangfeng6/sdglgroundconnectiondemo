...
public class Reportrestaurant {
    ...
    public int hashCode() {
        ...
        return Objects.hash(reportRestaurantId, lunchDate, luncheonName, lunchMeal, lunchEatNum, lunchother, lunchPayMethods, dinnerDate, dinnerName, dinnerMeal, dinnerEatNum, dinnerother, dinnerPayMethods, status, createBy, updateBy, upDate, createDate, reportDetailId, value2, value3);
    }
}
